...
\subsubscection{P1-P1-P1 discretization with $\Gamma$ conformity}
...
\subsubscection{P1-P1-P0 discretization with $\Gamma$ conformity}
...
\subsubscection{Non-conforming setting}
