...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=0.35\textwidth,angle=-90]{domain.tex}
\end{center}
...
\centering
\includegraphics[width=0.32\textwidth]{ext_patch.tex}
\includegraphics[width=0.32\textwidth]{gamma_generated.tex}
\includegraphics[width=0.32\textwidth]{intersection.tex}
\caption{
...
\begin{figure}
 \centering
 \includegraphics[width=0.45\textwidth]{conform_mesh.pdf}
 \includegraphics[width=0.45\textwidth]{nonconform_mesh.pdf} 
 \vspace{-10pt}
 \captionof{figure}{
   (Left)
...
\begin{figure}
\centering
\includegraphics[width = 0.6\textwidth]{mfs_LM2d}
\includegraphics[width = 0.3\textwidth]{mfs_LM1d_crop}
\vspace{-10pt}
