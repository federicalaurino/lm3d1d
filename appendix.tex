...
Hence, we have obtained the Problem 3D-2D-1D, equation 
\eqref{eq:problem1}:
...
\end{align*}
\end{subequations}
This coupled problem is classified as 3D-2D-1D because the unknowns $u,\lambda,\ud$ belong to 
...
are $X^1_{h, 0}(\Omega)\times X^1_{h, 0}(\Lambda)\times Q_h(\Gamma)$,
      ...
      and 
      $X^1_{h, 0}(\Omega)\times X^1_{h^{\prime}, 0}(\Lambda)\times Q_h(\mathcal{G}_h)$.
