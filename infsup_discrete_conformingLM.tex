...
\begin{theorem}[Ern-Guermond 2.42]
...
%\sup_{q_h \in Q_h(\Lambda)} \frac{ \langle q_h, {\md}_h \rangle_{\Lambda} } {\|q_h\|_{H^{\frac 12}(\Lambda)}} 
%\\
%\lesssim \sup_{q_h \in Q_h(\Lambda)} \frac{ \langle q_h, {\md}_h \rangle _{\Lambda}} {\|\mathcal{U}_E q_h\|_{H^{\frac 12}(\Gamma)}} 
%\lesssim \|\mathcal{E}\| \sup_{q_h \in Q_h(\Lambda)} \frac{ \langle q_h, {\md}_h \rangle _{\Lambda} } {\|\mathcal{E} \mathcal{U}_E q_h\|_{H^1(\Omega)}} 
%\\
%\lesssim \|\mathcal{E}\| C_R \sup_{q_h \in Q_h(\Lambda)} \frac{ \langle q_h, {\md}_h \rangle _{\Lambda} } {\|R_h E \mathcal{U}_E q_h\|_{H^1(\Omega)}}
%\\ 
%\lesssim\|\mathcal{E}\| C_R \sup_{q_h \in Q_h(\Lambda)} \frac{ \langle \avrc{TR_h E \mathcal{U}_E q_h}, {\md}_h \rangle _{\Lambda}} {\|R_h E \mathcal{U}_E q_h\|_{H^1(\Omega)}}
%\\
