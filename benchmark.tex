...
\hline
  ...
  \captionof{table}{Error convergence on a benchmark problem \eqref{benchmark}.
    (Top) problem \eqref{eq:problem1_simple}, (middle) \eqref{eq:problem2_simple} wity
    conforming disretization and (bottom) \eqref{eq:problem2_simple} in case
...
\caption{Numerical solution of problem \eqref{eq:problem1_simple} and
  \eqref{eq:problem2_simple}. (Left) function $u_h$, $\udh$ (practically identical
